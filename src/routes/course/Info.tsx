...
import { addToShopCart, removeFormShopCart, queryCourseInfo } from "../../api/course";
  ...
  public render() {
    ...
    return (
      <div className="base-info">
        <video src="" controls preload="none" poster={pic} />
        <div className="content">
          ...
          {// 如果当前课程已经支付成功,不显示按钮
            isInShop !== 1 ? (
              <Button type={isInShop === -1 ? "danger" : "primary"} onClick={this.handleBuy}>
